            ...
            <div className="mt-0 bg-white rounded-b-lg shadow-card p-6">
                ...
                {restrictedTabs.includes(activeTab) && !hasAccess ? (
                    ...
                    <>
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                    ...
                                    <div className="border border-gray-200 rounded-lg p-5 bg-white">
                                        ...
                                        <div className="pt-3 border-t border-gray-100">
                                            <div className="text-xs text-gray-400 uppercase tracking-wide mb-3">{t('closest_competitors')}</div>
                                            {isLoadingDetails ? (
                                                            ...
                                                            <>
                                                                ...
                                                                <div className="flex justify-between items-center text-sm bg-primary/5 border border-primary/10 rounded pl-0 pr-2 py-1.5 relative z-10 shadow-sm">
                                                                    ...
                                                                    <span className="text-[11px] font-bold text-primary">
                                                                        {company.finances?.turnover >= 1000000
                                                                            ? `${(company.finances?.turnover / 1000000).toFixed(1)} M€`
                                                                            : `${Math.round(company.finances?.turnover / 1000)} k€`}
                                                                    </span>
                                                                </div>
                        ...
                        {activeTab === "finances" && (
                            <FinancialAnalysisTab company={company} />
                        )}
