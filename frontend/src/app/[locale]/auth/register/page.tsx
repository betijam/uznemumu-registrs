                ...
                <div className="mx-auto mb-10 w-80 bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/10 shadow-2xl">
                    <div className="text-left space-y-4">
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <div className="text-sm font-semibold text-white">{t('promo_reg_feat1_title')}</div>
                                <div className="text-xs text-gray-400">{t('promo_reg_feat1_desc')}</div>
                            </div>
                        </div>
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <div className="text-sm font-semibold text-white">{t('promo_reg_feat2_title')}</div>
                                <div className="text-xs text-gray-400">{t('promo_reg_feat2_desc')}</div>
                            </div>
                        </div>
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <div className="text-sm font-semibold text-white">{t('promo_reg_feat3_title')}</div>
                                <div className="text-xs text-gray-400">{t('promo_reg_feat3_desc')}</div>
                            </div>
                        </div>
                    </div>
                </div>

                <h2 className="text-3xl font-bold mb-4 tracking-tight">{t('promo_reg_main_title')}</h2>
                <p className="text-gray-400 text-lg leading-relaxed mb-8">
                    {t('promo_reg_main_desc')}
                </p>
...
export default function RegisterPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!agreedToTerms) {
            setError(t('error_agree_to_terms')); // Add this key or use a generic one
            return;
        }
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-white">
                <div className="text-center">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 mb-2">{t('success_register')}</h2>
                    <p className="text-gray-600">{t('success_register_desc')}</p>
                </div>
            </div>
        );
    }
        ...
        <div className="min-h-screen w-full flex">
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 md:px-16 lg:px-24 bg-white relative">
                ...
                <div className="max-w-md w-full mx-auto pt-24 lg:pt-8">
                    {/* Header */}
                    <div className="mb-8">
                        <h1 className="text-3xl font-bold text-gray-900 tracking-tight">{t('create_account')}</h1>
                        <p className="mt-2 text-sm text-gray-600">{t('register_subtitle')}</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="flex items-start gap-3 mt-2">
                            ...
                            <label htmlFor="terms" className="text-sm text-gray-600">
                                ...
                                <Link href="/privacy" className="text-blue-600 hover:underline">{t('privacy_policy')}</Link>.
                            </label>
                        </div>
